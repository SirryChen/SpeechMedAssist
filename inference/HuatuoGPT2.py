...
class HuatuoGPT2:
    def __init__(self, model_path, input_speech=False, output_speech=False, speech_output_dir="HuatuoGPT2_output"):
    ...
    def reply(self, messages, round_idx=0):
        ...
        reply = self.model.HuatuoChat(self.tokenizer, new_messages)
